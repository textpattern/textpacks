...
When creating entirely new translations, always use the @en-gb.textpack@ as your template and reference point - this file is always up to date. Start by creating a new empty Textpack file:
...
After that is done, sync the language name to other translations:

bc. $ ./textpack

This will also populate your @xx-xx.textpack@ file with an empty Textpack template.
